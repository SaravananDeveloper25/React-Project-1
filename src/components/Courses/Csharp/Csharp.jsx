...
import Faq from './CsharpFaq';
import Certificate from '../java/Certificate';
import CsharpReview from './CsharpReview'
                ...
                <Container >
                    <Row className='banner_row'>
                        <Col xs={12} md={12} xl={8} className='banner_col mt-4'>
                            <h1>C#(C Sharp) Training Course</h1>
                            <p>Join the program and get the opportunity to learn under the guidance of an C# specialist.</p>
                            <div>
                                <span>⭐️⭐️⭐️⭐️</span>
                                <span></span>
                            </div>
